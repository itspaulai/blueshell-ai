  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <div className={`${
        ...
        {/* Header Section */}
        <div className={`${isSidebarOpen ? "px-5" : "px-3"} pt-5 pb-2 flex-shrink-0`}>
        ...
        <div className={`flex-1 overflow-y-auto min-h-0 ${isSidebarOpen ? "px-5" : "px-3"} scrollbar-thin scrollbar-thumb-[#dde3ea] hover:scrollbar-thumb-[#c4c7c5] scrollbar-track-transparent`}>
        ...
        {/* Fixed Footer */}
        <div className={`${isSidebarOpen ? "px-5" : "px-3"} py-4 flex-shrink-0`}>
